...
public class CreateEditPropertyPopUpDefaultValueIT extends AbstractTestCMM
{
    /** The logger */
    private static Log logger = LogFactory.getLog(CreateEditPropertyPopUpDefaultValueIT.class);

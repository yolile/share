...
public class SiteLinksToDefaultPageIT extends AbstractSiteDashletTest
{
    private static Log logger = LogFactory.getLog(SiteLinksToDefaultPageIT.class);
    ...
    public void testSelectSiteNameFromSiteContentDashlet() throws Exception
    {
        ...
        SiteContentDashlet dashlet = null;
        while (true)
        {
            timer.start();
            try
    ...
    public void testSelectSiteNameFromSiteActivitiesDashlet() throws Exception
    {
        ...
        // This dashlet should not take over a minute to display content list.
        RenderTime timer = new RenderTime(60000);
        SiteActivitiesDashlet dashlet = null;
        while (true)
        {
            timer.start();
            try

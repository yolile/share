...
public class MyActivitiesDashletIT extends AbstractDashletTest
{
    private static Log logger = LogFactory.getLog(MyActivitiesDashletIT.class);
    ...
    {
        List<ActivityShareLink> activities = null;
